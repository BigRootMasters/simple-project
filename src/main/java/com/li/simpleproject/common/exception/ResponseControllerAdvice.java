 ...
 * @date 2023/10/6 19:05
 */
@RestControllerAdvice(basePackages = {"com.li.simpleproject.controller"})
public class ResponseControllerAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object data, MethodParameter returnType, @NotNull MediaType mediaType, @NotNull Class<? extends HttpMessageConverter<?>> aClass,
